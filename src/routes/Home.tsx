...
function HomeComponent() {
  ...
  return (
    <div className="w-full sm:flex-row lg:flex-row md:flex-row bg-sunset flex flex-col w-[80%]">
      <Navbar />
      <div className=" grid w-full grid-cols-1 lg:grid-cols-2 sm:grid-cols-1 grid-flow-row sm:w-full  sm:m-6 md:m-6 lg:m-6 gap-8">
        <div className="sm:p-2 md:p-2 lg:p-2 w-[80%] flex flex-col border-2 text-white border-black bg-gradient-to-br from-gray-700 to-gray-950">
