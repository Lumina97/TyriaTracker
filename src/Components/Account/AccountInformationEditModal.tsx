...
const AccountInformationEditModal = ({
  ...
  return (
    <div className="rounded-md absolute drop-shadow-black   sm:left-1/2 sm:-translate-x-1/2   m-auto px-4 top-1/4 sm:top-1/2 sm:-translate-y-1/2  w-[98%] ml-[01%] sm:w-3/4 md:max-w-[650px] text-white bg-slate-800 border-white border-[1px]">
